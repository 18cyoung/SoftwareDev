...
if Fragment in DNA:
    print("The DNA fragment is present in the provided sequence.")
    print("It is at the location [",Sus,",",(Sus+len(Fragment)),"]")
else:
    print("The DNA fragment is not present in the provided sequence.")

#Confirm that the found fragment is correct
print("The fragment is:",DNA[Sus:Sus+len(Fragment)])